...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Implementation.user'
        db.add_column(u'algorithm_implementation', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Algorithm.user'
        db.add_column(u'algorithm_algorithm', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Implementation.user'
        db.delete_column(u'algorithm_implementation', 'user_id')

        # Deleting field 'Algorithm.user'
        db.delete_column(u'algorithm_algorithm', 'user_id')
