...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserReputation.university'
        db.add_column(u'algorithm_userreputation', 'university',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['algorithm.UniversityRank'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserReputation.university'
        db.delete_column(u'algorithm_userreputation', 'university_id')
    ...
    models = {
        u'algorithm.algorithm': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 11, 26, 0, 0)'}),
