...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AlgorithmFullText'
        db.create_table(u'algorithm_algorithmfulltext', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('alg_name', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('description', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'algorithm', ['AlgorithmFullText'])


    def backwards(self, orm):
        # Deleting model 'AlgorithmFullText'
        db.delete_table(u'algorithm_algorithmfulltext')
    ...
    models = {
        u'algorithm.algorithm': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2016, 10, 1, 0, 0)'}),
        ...
        u'algorithm.algorithmfulltext': {
            'Meta': {'object_name': 'AlgorithmFullText'},
            'alg_name': ('django.db.models.fields.CharField', [], {'max_length': '30'}),
            'description': ('django.db.models.fields.TextField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        ...
        u'algorithm.paradigm': {
            'Meta': {'object_name': 'Paradigm'},
            'abstract': ('django.db.models.fields.TextField', [], {}),
            'dbpedia_uri': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'label': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'wikipedia_uri': ('django.db.models.fields.CharField', [], {'max_length': '100'})
        },
