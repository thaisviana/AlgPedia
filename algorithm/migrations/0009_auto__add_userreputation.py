...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UserReputation'
        db.create_table(u'algorithm_userreputation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('reputation', self.gf('django.db.models.fields.FloatField')(default=0)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal(u'algorithm', ['UserReputation'])


    def backwards(self, orm):
        # Deleting model 'UserReputation'
        db.delete_table(u'algorithm_userreputation')
    ...
    models = {
        u'algorithm.algorithm': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 11, 22, 0, 0)'}),
