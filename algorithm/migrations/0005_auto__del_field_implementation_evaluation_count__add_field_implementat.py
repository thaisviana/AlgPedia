...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Implementation.accumulated_weight'
        db.add_column(u'algorithm_implementation', 'accumulated_weight',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Implementation.accumulated_weight'
        db.delete_column(u'algorithm_implementation', 'accumulated_weight')
