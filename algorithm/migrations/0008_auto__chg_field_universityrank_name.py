...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UniversityRank.name'
        db.alter_column(u'algorithm_universityrank', 'name', self.gf('django.db.models.fields.CharField')(max_length=60))

    def backwards(self, orm):

        # Changing field 'UniversityRank.name'
        db.alter_column(u'algorithm_universityrank', 'name', self.gf('django.db.models.fields.CharField')(max_length=35))
