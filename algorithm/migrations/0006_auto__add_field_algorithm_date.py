...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Algorithm.date'
        db.add_column(u'algorithm_algorithm', 'date',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 11, 4, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Algorithm.date'
        db.delete_column(u'algorithm_algorithm', 'date')
