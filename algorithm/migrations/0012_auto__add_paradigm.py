...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'algorithm_paradigm', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('dbpedia_uri', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('wikipedia_uri', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('label', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('abstract', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'algorithm', ['Paradigm'])


    def backwards(self, orm):
        # Deleting model 'Paradigm'
        db.delete_table(u'algorithm_paradigm')
    ...
    models = {
        u'algorithm.algorithm': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2016, 2, 14, 0, 0)'}),
