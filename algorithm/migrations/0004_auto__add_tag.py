...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Tag'
        db.create_table(u'algorithm_tag', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal(u'algorithm', ['Tag'])

        # Adding M2M table for field tags on 'Algorithm'
        db.create_table(u'algorithm_algorithm_tags', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('algorithm', models.ForeignKey(orm[u'algorithm.algorithm'], null=False)),
            ('tag', models.ForeignKey(orm[u'algorithm.tag'], null=False))
        ))
        db.create_unique(u'algorithm_algorithm_tags', ['algorithm_id', 'tag_id'])


    def backwards(self, orm):
        # Deleting model 'Tag'
        db.delete_table(u'algorithm_tag')

        # Removing M2M table for field tags on 'Algorithm'
        db.delete_table('algorithm_algorithm_tags')
